...
import com.breakinblocks.animusnv.items.sigils.AnimusSigilBase;
...
/**
 * Sigil of Crimson Will - Empowers spell casting with Spiritus and EV
 *
 * Features:
...
public class ItemSigilCrimsonWill extends AnimusSigilBase {
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
        ...
        tooltip.add(Component.literal("Empowers spells with Spiritus and blood")
            .withStyle(ChatFormatting.DARK_RED));
        ...
        tooltip.add(Component.literal("  • Base: +30% spell & summon damage")
            .withStyle(ChatFormatting.GRAY));
        tooltip.add(Component.literal("  • Scales up to +50% (at 4096 Spiritus)")
            .withStyle(ChatFormatting.GRAY));
        ...
        tooltip.add(Component.literal("Cost per spell cast:")
            .withStyle(ChatFormatting.GOLD));
        tooltip.add(Component.literal("  • " + AnimusConfig.ironsSpells.crimsonWillLPPerMana.get() + " EV per mana point")
            .withStyle(ChatFormatting.GRAY));
        tooltip.add(Component.literal(""));
