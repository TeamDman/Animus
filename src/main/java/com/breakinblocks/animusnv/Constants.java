...
public class Constants {
    ...
    public static class Tags {
        ...
        public static final TagKey<Item> MALUM_SOUL_SHATTER_CAPABLE_WEAPON =
            TagKey.create(
                Registries.ITEM,
                ResourceLocation.fromNamespaceAndPath("malum", "soul_shatter_capable_weapon")
            );

        public static final TagKey<Item> MALUM_ENCHANTABLE_REBOUND =
            TagKey.create(
                Registries.ITEM,
                ResourceLocation.fromNamespaceAndPath("malum", "enchantable/rebound")
            );

        public static final TagKey<Item> MALUM_ENCHANTABLE_ASCENSION =
            TagKey.create(
                Registries.ITEM,
                ResourceLocation.fromNamespaceAndPath("malum", "enchantable/ascension")
            );
