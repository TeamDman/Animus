...
public class CrystallizedSpiritusBlockEntry extends EntryProvider {
    ...
    protected void generatePages() {
        this.page("recipe", () -> BookStonecuttingRecipePageModel.create()
                .withRecipeId1(ResourceLocation.fromNamespaceAndPath("animusnv", "crystallized_spiritus_block_from_crystal_cluster"))
                .withRecipeId2(ResourceLocation.fromNamespaceAndPath("animusnv", "crystal_cluster_from_crystallized_spiritus_block")));
