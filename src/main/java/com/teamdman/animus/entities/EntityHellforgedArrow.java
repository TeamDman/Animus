 ...
 * - Applies status effects based on demon will type
 */
public class EntityHellforgedArrow extends AbstractArrow {
    ...
    public EntityHellforgedArrow(Level level, LivingEntity shooter) {
        super(AnimusEntityTypes.HELLFORGED_ARROW.get(), shooter, level);
        this.pickup = Pickup.DISALLOWED;
    }
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(ID_CHARGE_MULTIPLIER, 0.0F);
        this.entityData.define(ID_EXECUTE_THRESHOLD, 0.0F);
    }
     ...
     */
    private void applyWillEffects(LivingEntity target, EnumDemonWillType willType, int level,
        ...
        switch (willType) {
            ...
            case DESTRUCTIVE:
                ...
                target.setSecondsOnFire((int)(3 * durationMultiplier) + level);
