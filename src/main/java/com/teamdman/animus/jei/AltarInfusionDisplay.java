...
public class AltarInfusionDisplay {
    ...
    private final int fromTier;              // For upgrades: source tier
    private final int toTier;                // For upgrades: target tier
    private final String requiredOrb;        // For upgrades: orb name required
    ...
    /**
     * Constructor for SPELLBOOK_UPGRADE type (tier upgrades)
     */
