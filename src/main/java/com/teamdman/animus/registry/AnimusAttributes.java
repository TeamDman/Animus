...
public class AnimusAttributes {
     ...
     * Value interpreted as a fractional multiplier (e.g. 0.5 = 50% bonus)
     */
     ...
     * Value interpreted as a fractional multiplier (e.g. 1.0 = 100% bonus = double will)
     */
     ...
     * Value interpreted as a fractional multiplier (e.g. 0.5 = 50% cost reduction)
     */
