...
public class BlockLeaves extends BlockNewLeaf {
  ...
  public void updateTick(World world, int posX, int posY, int posZ, Random rnd) {
    if (!world.isRemote) {
      ...
      if (world
          .checkChunksExist(posX - i1, posY - i1, posZ - i1, posX + i1, posY + i1, posZ + i1)) {
        int i2;
        int j2;
          ...
          for (i2 = -b0; i2 <= b0; ++i2) {
            for (j2 = -b0; j2 <= b0; ++j2) {
              for (int k2 = -b0; k2 <= b0; ++k2) {
                if (this.leafNodes[(i2 + k1) * j1 + (j2 + k1) * b1 + k2 + k1] == l1 - 1) {
                  if (this.leafNodes[(i2 + k1 - 1) * j1 + (j2 + k1) * b1 + k2 + k1] == -2) {
                    this.leafNodes[(i2 + k1 - 1) * j1 + (j2 + k1) * b1 + k2 + k1] = l1;
                  }
                  ...
                  if (this.leafNodes[(i2 + k1) * j1 + (j2 + k1 - 1) * b1 + k2 + k1] == -2) {
                    this.leafNodes[(i2 + k1) * j1 + (j2 + k1 - 1) * b1 + k2 + k1] = l1;
                  }
                  ...
                  if (this.leafNodes[(i2 + k1) * j1 + (j2 + k1) * b1 + (k2 + k1 - 1)] == -2) {
                    this.leafNodes[(i2 + k1) * j1 + (j2 + k1) * b1 + (k2 + k1 - 1)] = l1;
                  }
