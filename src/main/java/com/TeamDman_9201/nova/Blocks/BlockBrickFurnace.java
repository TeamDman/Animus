...
public class BlockBrickFurnace extends BlockContainer {
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        ...
        this.iconFrontActive = iconRegister.registerIcon(NOVA.MODID + ":" +
                "blockBrickFurnaceFrontActive");
        this.iconFrontIdle = iconRegister.registerIcon(NOVA.MODID + ":" +
                "blockBrickFurnaceFrontIdle");
    }
     ...
     */
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase
            entityLivingBase, ItemStack item) {
        int l = MathHelper.floor_double((double) (entityLivingBase.rotationYaw * 4.0F / 360.0F) +
                0.5D) & 3;
        int face = 2;
        if (l == 0) {
            face = 2;
                    ...
                    if (itemstack != null) {
                        ...
                        while (itemstack.stackSize > 0) {
                            ...
                            EntityItem entityitem = new EntityItem(world, (double) ((float) x +
                                    f), (double) ((float) y + f1), (double) ((float) z + f2), new
    ...
    public void randomDisplayTick(World world, int x, int y, int z, Random rand) {
        if (activeFromMeta(world.getBlockMetadata(x, y, z))) {
            ...
            if (l == 4) {
                world.spawnParticle("smoke", (double) (f - f3), (double) f1, (double) (f2 + f4),
                        0.0D, 0.0D, 0.0D);
                world.spawnParticle("flame", (double) (f - f3), (double) f1, (double) (f2 + f4),
                        0.0D, 0.0D, 0.0D);
            } else if (l == 5) {
                world.spawnParticle("smoke", (double) (f + f3), (double) f1, (double) (f2 + f4),
                        0.0D, 0.0D, 0.0D);
                ...
                world.spawnParticle("smoke", (double) (f + f4), (double) f1, (double) (f2 - f3),
                        0.0D, 0.0D, 0.0D);
                world.spawnParticle("flame", (double) (f + f4), (double) f1, (double) (f2 - f3),
                        0.0D, 0.0D, 0.0D);
            } else if (l == 3) {
                world.spawnParticle("smoke", (double) (f + f4), (double) f1, (double) (f2 + f3),
                        0.0D, 0.0D, 0.0D);
