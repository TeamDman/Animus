...
public class TileBrickFurnace extends TileEntity implements ISidedInventory {
    ...
    public static int getItemBurnTime(ItemStack p_145952_0_) {
        if (p_145952_0_ == null) {
            ...
            if (item instanceof ItemTool && ((ItemTool) item).getToolMaterialName().equals
                    ("WOOD")) {
                return 200;
            }
            if (item instanceof ItemSword && ((ItemSword) item).getToolMaterialName().equals
                    ("WOOD")) {
                return 200;
            }
    ...
    public void updateEntity() {
        ...
        if (!this.worldObj.isRemote) {
            if (this.furnaceBurnTime == 0 && this.canSmelt()) {
                this.currentItemBurnTime = this.furnaceBurnTime = getItemBurnTime(this
                        .furnaceItemStacks[1]);
                ...
                if (this.furnaceBurnTime > 0) {
                    ...
                    if (this.furnaceItemStacks[1] != null) {
                        if (this.furnaceItemStacks[1].isItemEqual(new ItemStack(NOVA
                                .itemSuperCoal, 1))) {
            ...
            if (flag != this.furnaceBurnTime > 0) {
                flag1 = true;
                BlockBrickFurnace.updateFurnaceBlockState(this.furnaceBurnTime > 0, this
    ...
    private boolean canSmelt() {
        if (this.furnaceItemStacks[0] == null) {
            ...
            ItemStack itemstack = FurnaceRecipes.smelting().getSmeltingResult(this
                    .furnaceItemStacks[0]);
            if (itemstack == null) {
                return false;
            }
    ...
    public void smeltItem() {
        if (this.canSmelt()) {
            ...
            if (this.furnaceItemStacks[2] == null) {
                ...
                this.furnaceItemStacks[2].stackSize += itemstack.stackSize; // Forge BugFix:
                // Results may have multiple items
            }
    ...
    /**
     * Returns an array containing the indices of the slots that can be accessed by automation on
