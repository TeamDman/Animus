...
public final class AnimusInlineTest extends GameTestInstance {
    ...
    private static final MapCodec<AnimusInlineTest> CODEC = MapCodec.unit(() -> {
        throw new UnsupportedOperationException("AnimusInlineTest is registered programmatically, not decoded");
    });
